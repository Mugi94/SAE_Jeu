...
def pause_menu(screen):
    ...
    title = title_font.render("PAUSE", True, (255, 255, 255)) ; title_rect = title.get_rect(center=(const.WIDTH//2, 250))
    screen.blit(title, title_rect)

    quit_button = Bouton(None, (const.WIDTH//2, 450), "QUITTER", text_font, "black", "White") ; quit_button.changeColor(mouse_pos)
    quit_button.update(screen)
    
    back_button = Bouton(None, (const.WIDTH//2, 350), "REPRENDRE", text_font, "black", "White") ; back_button.changeColor(mouse_pos)
